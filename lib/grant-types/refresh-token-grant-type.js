...
function RefreshTokenGrantType(options) {
  ...
  if (options.alwaysIssueNewRefreshToken === true && !options.model.revokeToken) {
...
RefreshTokenGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    ...
    .then(function(token) {
      return this.saveToken(token.user, client, token.scope, token.refreshToken, token.refreshTokenExpiresAt);
    });
};
...
RefreshTokenGrantType.prototype.saveToken = function(user, client, scope, previousRefreshToken, previousRefreshTokenExpiresAt) {
  var fns = [
